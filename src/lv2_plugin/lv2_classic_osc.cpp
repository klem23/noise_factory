...
void init(void){
	...
	oscDesc->deactivate = NULL;
	oscDesc->connect_port = connectPort;
	oscDesc->instantiate = instantiate;
	oscDesc->cleanup = cleanup;
	oscDesc->run = run;
	oscDesc->extension_data = NULL;
}
